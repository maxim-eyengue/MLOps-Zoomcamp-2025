...
# from prefect_aws import S3Bucket # for loafing the data from an S3 bucket
from prefect.artifacts import create_markdown_artifact # for reporting
...
def create_X(df, dv = None):
    """Creates Features from DataFrame"""
...
def train_model(X_train, y_train, X_val, y_val, dv):
    ...
    with mlflow.start_run() as run:
        ...
        # Create a report for visualizing in Prefect
...
def run_s3(year, month):
    ...
    # If reading the data from an s3 bucket
    # Load
...
if __name__ == "__main__":
    ...
    run_id = run_s3(year = args.year, month = args.month)
